...
const RestaurantCard = (props) =>{
    ...
    return (
        ...
        <img className= "res-logo" alt="res-logo" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,h_600/"+ resData.card.restaurants[5].info.cloudinaryImageId }/>    
        <h3>{resData.card.restaurants[5].info.name}</h3>
        <h4>{resData.card.restaurants[5].info.cuisines.join(", ")}</h4>
        <h4>{resData.card.restaurants[5].info.avgRatingString} stars</h4>
        <h4>{resData.card.restaurants[5].info.sla.deliveryTime} minutes</h4>
        <h4>{resData.card.restaurants[5].info.costForTwo}</h4>
        </div>
    )
}
